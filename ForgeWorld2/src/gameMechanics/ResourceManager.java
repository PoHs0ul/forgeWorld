...
public class ResourceManager {
	...
	public void addRes(int resID,double amount){
	...
	public boolean remRes(int resID, double amount){
	...
	public boolean possibleToRemResByIDs(ArrayList<Integer> itemIDs, ArrayList<Double> amounts){
	...
	public boolean remResByIDs(ArrayList<Integer> itemIDs, ArrayList<Double> amounts){
